<h2><a href="https://www.geeksforgeeks.org/problems/count-the-number-of-subarrays/1?_gl=1*1j12a6x*_up*MQ..*_gs*MQ..&gclid=CjwKCAjwvsvTBhBaEiwAmf-3nmgDZt1xsNNhTOBfz0dTi-L3djRSbKrnyxfNQUrAGucmlTMutrzrVRoCQjcQAvD_BwE&gbraid=0AAAAAC9yBkBGNaaIVN5QdBm1ahg7DqA1m">Subarrays with Sum in Range</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an integer array <strong>arr[]</strong> and two integers <strong>l</strong> and <strong>r</strong>, find the number of subarrays whose sum lies in the range [l, r] (inclusive).</span></p>
